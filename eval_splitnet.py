...
def get_eval_dataset(shell_args, data_subset="val"):
    if shell_args.dataset == "mp3d":
        ...
        # ### zhr3.0-pointNav
        # data_path = "/home/u/Desktop/splitnet/data/datasets/pointnav/gibson/v1/val/PointNav1000.json.gz"
...
class HabitatRLEvalRunner(BaseHabitatRLRunner):
    ...
    def setup(self, create_decoder):
        ...
        if self.shell_args.data_subset == "val":
    ...
    def evaluate_model(self):
        ...
        # zhr_success = []
        # zhr_validity = []
        with open("/home/u/Desktop/splitnet/output_files/pointnav/gibson/splitnet_pretrain_supervised_rl/results/val/PointNav1000.csv","a+") as zhr_csvfile:
                ...
                try:
                    ...
                    for ii in to_pause:
                        ...
                        for key in eval_stats:
                            try:
                                ### zhr3.0
                                if not isinstance(eval_stats[key],float): # the last key is "validity" and eval_stats[key] is not list but a float
